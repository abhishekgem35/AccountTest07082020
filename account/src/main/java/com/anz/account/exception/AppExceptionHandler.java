...
public class AppExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleAnyException(Exception ex, WebRequest request)
	{
		...
		ErrorMessage errorMsg = new ErrorMessage(new Date(), errorMessageDescription);		
		return new ResponseEntity<>(errorMsg, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
	}
	
	@ExceptionHandler(value= {NullPointerException.class, AccountServiceException.class})
